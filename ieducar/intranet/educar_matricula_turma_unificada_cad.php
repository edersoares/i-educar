...
class clsIndexBase extends clsBase
{
    ...
    {
        $this->SetTitulo("{$this->_instituicao} i-Educar - Etapa da turma unificada");
        $this->processoAp = "578";
...
class indice extends clsCadastro
{
    ...
    public function Gerar()
    {
        ...
        $enturmacoes = $enturmacoes->lista(
            ...
            false, null, false, false, false, null, false, true
        );
        ...
        foreach ($enturmacoes as $enturmacao) {
            ...
            $this->campoLista("etapas_educacenso[{$enturmacao['ref_cod_turma']}-{$enturmacao['sequencial']}]", "Etapa da turma unificada: {$enturmacao['nm_turma']}", $resources, $enturmacao['turma_unificada'], '', false, '', '', false, false);
        }
    }
    ...
    public function Editar()
    {
        ...
        foreach ($this->etapas_educacenso as $codTurmaESequencial => $etapaEducacenso) {
            ...
            $obj->turma_unificada = $etapaEducacenso;
            $obj->edita();
        }
