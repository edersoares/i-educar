...
-- View: relatorio.view_dados_historico_posicionamento
...
SELECT he.ref_cod_aluno,
       ...
       ( SELECT COALESCE(min(hdd2.ordenamento), 9999) AS "coalesce"
         FROM historico_escolar hee2
                  JOIN historico_disciplinas hdd2 ON hdd2.ref_ref_cod_aluno = hee2.ref_cod_aluno AND hdd2.ref_sequencial = hee2.sequencial
...
FROM ( SELECT hd_1.sequencial,
              ...
              hd_1.faltas,
              hd_1.ordenamento
       FROM historico_disciplinas hd_1) hd
         JOIN historico_escolar he ON hd.ref_ref_cod_aluno = he.ref_cod_aluno AND hd.ref_sequencial = he.sequencial
         LEFT JOIN historico_escolar he1 ON he1.ref_cod_aluno = he.ref_cod_aluno AND he1.posicao = 1 AND he1.ativo = 1 AND he1.sequencial = (( SELECT hee.sequencial
                                                                                                                                               ...
                                                                                                                                               LIMIT 1))
         LEFT JOIN historico_escolar he2 ON he2.ref_cod_aluno = he.ref_cod_aluno AND he2.posicao = 2 AND he2.ativo = 1 AND he2.sequencial = (( SELECT hee.sequencial
                                                                                                                                               FROM historico_escolar hee
                                                                                                                                               WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND hee.posicao = 2 AND hee.ativo = 1
                                                                                                                                               ORDER BY hee.ano DESC, hee.aprovado
                                                                                                                                               LIMIT 1))
         LEFT JOIN historico_escolar he3 ON he3.ref_cod_aluno = he.ref_cod_aluno AND he3.posicao = 3 AND he3.ativo = 1 AND he3.sequencial = (( SELECT hee.sequencial
                                                                                                                                               FROM historico_escolar hee
                                                                                                                                               WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND hee.posicao = 3 AND hee.ativo = 1
                                                                                                                                               ORDER BY hee.ano DESC, hee.aprovado
                                                                                                                                               LIMIT 1))
         LEFT JOIN historico_escolar he4 ON he4.ref_cod_aluno = he.ref_cod_aluno AND he4.posicao = 4 AND he4.ativo = 1 AND he4.sequencial = (( SELECT hee.sequencial
                                                                                                                                               FROM historico_escolar hee
                                                                                                                                               WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND hee.posicao = 4 AND hee.ativo = 1
                                                                                                                                               ORDER BY hee.ano DESC, hee.aprovado
                                                                                                                                               LIMIT 1))
         LEFT JOIN historico_escolar he5 ON he5.ref_cod_aluno = he.ref_cod_aluno AND he5.posicao = 5 AND he5.ativo = 1 AND he5.sequencial = (( SELECT hee.sequencial
                                                                                                                                               FROM historico_escolar hee
                                                                                                                                               WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND hee.posicao = 5 AND hee.ativo = 1
                                                                                                                                               ORDER BY hee.ano DESC, hee.aprovado
                                                                                                                                               LIMIT 1))
         LEFT JOIN historico_escolar he6 ON he6.ref_cod_aluno = he.ref_cod_aluno AND he6.posicao = 6 AND he6.ativo = 1 AND he6.sequencial = (( SELECT hee.sequencial
                                                                                                                                               FROM historico_escolar hee
                                                                                                                                               WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND hee.posicao = 6 AND hee.ativo = 1
                                                                                                                                               ORDER BY hee.ano DESC, hee.aprovado
                                                                                                                                               LIMIT 1))
         LEFT JOIN historico_escolar he7 ON he7.ref_cod_aluno = he.ref_cod_aluno AND he7.posicao = 7 AND he7.ativo = 1 AND he7.sequencial = (( SELECT hee.sequencial
                                                                                                                                               FROM historico_escolar hee
                                                                                                                                               WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND hee.posicao = 7 AND hee.ativo = 1
                                                                                                                                               ORDER BY hee.ano DESC, hee.aprovado
                                                                                                                                               LIMIT 1))
         LEFT JOIN historico_escolar he8 ON he8.ref_cod_aluno = he.ref_cod_aluno AND he8.posicao = 8 AND he8.ativo = 1 AND he8.sequencial = (( SELECT hee.sequencial
                                                                                                                                               FROM historico_escolar hee
                                                                                                                                               WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND hee.posicao = 8 AND hee.ativo = 1
                                                                                                                                               ORDER BY hee.ano DESC, hee.aprovado
                                                                                                                                               LIMIT 1))
         LEFT JOIN historico_escolar he9 ON he9.ref_cod_aluno = he.ref_cod_aluno AND he9.posicao = 9 AND he9.ativo = 1 AND he9.sequencial = (( SELECT hee.sequencial
                                                                                                                                               FROM historico_escolar hee
                                                                                                                                               WHERE hee.ref_cod_aluno = he.ref_cod_aluno AND hee.posicao = 9 AND hee.ativo = 1
                                                                                                                                               ORDER BY hee.ano DESC, hee.aprovado
                                                                                                                                               LIMIT 1))
         LEFT JOIN historico_disciplinas hd1 ON hd1.ref_ref_cod_aluno = hd.ref_ref_cod_aluno AND fcn_upper(hd1.nm_disciplina::text) = fcn_upper(hd.nm_disciplina) AND hd1.ref_sequencial = he1.sequencial
         LEFT JOIN historico_disciplinas hd2 ON hd2.ref_ref_cod_aluno = hd.ref_ref_cod_aluno AND fcn_upper(hd2.nm_disciplina::text) = fcn_upper(hd.nm_disciplina) AND hd2.ref_sequencial = he2.sequencial
         LEFT JOIN historico_disciplinas hd3 ON hd3.ref_ref_cod_aluno = hd.ref_ref_cod_aluno AND fcn_upper(hd3.nm_disciplina::text) = fcn_upper(hd.nm_disciplina) AND hd3.ref_sequencial = he3.sequencial
         LEFT JOIN historico_disciplinas hd4 ON hd4.ref_ref_cod_aluno = hd.ref_ref_cod_aluno AND fcn_upper(hd4.nm_disciplina::text) = fcn_upper(hd.nm_disciplina) AND hd4.ref_sequencial = he4.sequencial
         LEFT JOIN historico_disciplinas hd5 ON hd5.ref_ref_cod_aluno = hd.ref_ref_cod_aluno AND fcn_upper(hd5.nm_disciplina::text) = fcn_upper(hd.nm_disciplina) AND hd5.ref_sequencial = he5.sequencial
         LEFT JOIN historico_disciplinas hd6 ON hd6.ref_ref_cod_aluno = hd.ref_ref_cod_aluno AND fcn_upper(hd6.nm_disciplina::text) = fcn_upper(hd.nm_disciplina) AND hd6.ref_sequencial = he6.sequencial
         LEFT JOIN historico_disciplinas hd7 ON hd7.ref_ref_cod_aluno = hd.ref_ref_cod_aluno AND fcn_upper(hd7.nm_disciplina::text) = fcn_upper(hd.nm_disciplina) AND hd7.ref_sequencial = he7.sequencial
         LEFT JOIN historico_disciplinas hd8 ON hd8.ref_ref_cod_aluno = hd.ref_ref_cod_aluno AND fcn_upper(hd8.nm_disciplina::text) = fcn_upper(hd.nm_disciplina) AND hd8.ref_sequencial = he8.sequencial
         LEFT JOIN historico_disciplinas hd9 ON hd9.ref_ref_cod_aluno = hd.ref_ref_cod_aluno AND fcn_upper(hd9.nm_disciplina::text) = fcn_upper(hd.nm_disciplina) AND hd9.ref_sequencial = he9.sequencial
