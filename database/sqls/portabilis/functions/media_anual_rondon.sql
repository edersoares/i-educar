...
--
-- Name: media_anual_rondon(integer, integer); Type: FUNCTION; Schema: relatorio; Owner: ieducar
--

CREATE OR REPLACE FUNCTION media_anual_rondon(matricula_id_ integer, componente_id integer) RETURNS numeric
    LANGUAGE plpgsql
AS $$
DECLARE
    nota1 numeric;
