...
--
-- Name: get_nome_escola(integer); Type: FUNCTION; Schema: relatorio; Owner: postgres
--

CREATE OR REPLACE FUNCTION get_nome_escola(integer) RETURNS character varying
    LANGUAGE sql
