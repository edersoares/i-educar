...
CREATE OR REPLACE VIEW relatorio.view_historico_9anos AS
    SELECT historico_disciplinas.ref_ref_cod_aluno AS cod_aluno,
           ...
           (historico_por_disciplina.carga_horaria -> (historico_disciplinas.disciplina || '-' || '1' || '-carga_horaria'))::DOUBLE PRECISION carga_horaria1,
           (historico_por_disciplina.carga_horaria -> (historico_disciplinas.disciplina || '-' || '2' || '-carga_horaria'))::DOUBLE PRECISION carga_horaria2,
           (historico_por_disciplina.carga_horaria -> (historico_disciplinas.disciplina || '-' || '3' || '-carga_horaria'))::DOUBLE PRECISION carga_horaria3,
           (historico_por_disciplina.carga_horaria -> (historico_disciplinas.disciplina || '-' || '4' || '-carga_horaria'))::DOUBLE PRECISION carga_horaria4,
           (historico_por_disciplina.carga_horaria -> (historico_disciplinas.disciplina || '-' || '5' || '-carga_horaria'))::DOUBLE PRECISION carga_horaria5,
           (historico_por_disciplina.carga_horaria -> (historico_disciplinas.disciplina || '-' || '6' || '-carga_horaria'))::DOUBLE PRECISION carga_horaria6,
           (historico_por_disciplina.carga_horaria -> (historico_disciplinas.disciplina || '-' || '7' || '-carga_horaria'))::DOUBLE PRECISION carga_horaria7,
           (historico_por_disciplina.carga_horaria -> (historico_disciplinas.disciplina || '-' || '8' || '-carga_horaria'))::DOUBLE PRECISION carga_horaria8,
           (historico_por_disciplina.carga_horaria -> (historico_disciplinas.disciplina || '-' || '9' || '-carga_horaria'))::DOUBLE PRECISION carga_horaria9,
           ...
           (historico_por_disciplina.carga_horaria_disciplina -> (historico_disciplinas.disciplina || '-' || '1' || '-carga_horaria_disciplina'))::DOUBLE PRECISION carga_horaria_disciplina1,
           (historico_por_disciplina.carga_horaria_disciplina -> (historico_disciplinas.disciplina || '-' || '2' || '-carga_horaria_disciplina'))::DOUBLE PRECISION carga_horaria_disciplina2,
           (historico_por_disciplina.carga_horaria_disciplina -> (historico_disciplinas.disciplina || '-' || '3' || '-carga_horaria_disciplina'))::DOUBLE PRECISION carga_horaria_disciplina3,
           (historico_por_disciplina.carga_horaria_disciplina -> (historico_disciplinas.disciplina || '-' || '4' || '-carga_horaria_disciplina'))::DOUBLE PRECISION carga_horaria_disciplina4,
           (historico_por_disciplina.carga_horaria_disciplina -> (historico_disciplinas.disciplina || '-' || '5' || '-carga_horaria_disciplina'))::DOUBLE PRECISION carga_horaria_disciplina5,
           (historico_por_disciplina.carga_horaria_disciplina -> (historico_disciplinas.disciplina || '-' || '6' || '-carga_horaria_disciplina'))::DOUBLE PRECISION carga_horaria_disciplina6,
           (historico_por_disciplina.carga_horaria_disciplina -> (historico_disciplinas.disciplina || '-' || '7' || '-carga_horaria_disciplina'))::DOUBLE PRECISION carga_horaria_disciplina7,
           (historico_por_disciplina.carga_horaria_disciplina -> (historico_disciplinas.disciplina || '-' || '8' || '-carga_horaria_disciplina'))::DOUBLE PRECISION carga_horaria_disciplina8,
           (historico_por_disciplina.carga_horaria_disciplina -> (historico_disciplinas.disciplina || '-' || '9' || '-carga_horaria_disciplina'))::DOUBLE PRECISION carga_horaria_disciplina9,
